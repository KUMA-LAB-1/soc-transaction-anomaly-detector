...
def test_classification_benchmark_harness_orquestra_runs_por_seed(
    monkeypatch,
):
    import src.models.classification_benchmark_harness as harness
    from src.models.classification_benchmark_harness import (
        ClassificationBenchmarkHarnessResult,
        ClassificationBenchmarkRun,
        run_synthetic_classification_benchmark_multi_seed,
    )
    ...
    def fake_generate_synthetic_dataset_v3(
        **kwargs,
    ):
    ...
    def fake_run_synthetic_classification_benchmark(
        dataset,
    ):
    ...
    monkeypatch.setattr(
        ...
        fake_run_synthetic_classification_benchmark,
    )

    result = run_synthetic_classification_benchmark_multi_seed(
        seeds=seeds,
        quantidade=200,
        inicio=inicio,
        fim=fim,
...
def test_classification_benchmark_harness_rejeita_seeds_duplicadas(
    monkeypatch,
):
    import src.models.classification_benchmark_harness as harness
    from src.models.classification_benchmark_harness import (
